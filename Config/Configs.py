...
class VConfigs(Singleton):
    def __init__(self) -> None:
        if not super().created:
            ...
            self.PROJECT_URL = os.getenv('PROJECT_URL', 'https://github.com/nikkibraal/Di-Spot')
            ...
            self.INVITE_MESSAGE = os.getenv('INVITE_MESSAGE', """To invite Di-Spot to your own server, click [here]({}). 
            Or use this direct URL: {https://discord.com/oauth2/authorize?client_id=1340750470192304128}""")
